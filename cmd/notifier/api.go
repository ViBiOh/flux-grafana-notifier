...
func main() {
	...
	go appServer.Start(healthApp.ContextEnd(), "http", httputils.Handler(handler, healthApp, recoverer.Middleware, prometheusApp.Middleware, tracerApp.Middleware, owasp.New(owaspConfig).Middleware, cors.New(corsConfig).Middleware))
